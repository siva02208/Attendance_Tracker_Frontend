...
export class PostService {
  ...
  create(post:Post): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL + '/Students/', JSON.stringify(post), this.httpOptions)
  ...
  update(id:number, post:Post): Observable<any> {
    ...
    return this.httpClient.put(this.apiURL + '/Students/' + id, JSON.stringify(post), this.httpOptions)
